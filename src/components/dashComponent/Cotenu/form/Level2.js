...
const Level2 = ({ onPrevious, onSubmit, formObject }) => {
  ...
  return (
    <>
      ...
      <main className="  mt-5 md:mt-0 md:mb-0 h-screen w-full  flex flex-col justify-center px-4 items-center">
        <div className="max-w-sm md:max-w-xl w-full text-gray-600">
          <div className="-mb-3">
