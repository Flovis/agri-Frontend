      ...
      <div className="relative my-32 ">
        ...
        >
            ...
            <button onClick>
              <div className="flex items-center px-4 py-3 border-b border-borde-gray hover:bg-gray-100 -mx-2">
                <p className="text-gray-600 text-sm mx-2">
                  <span className="font-bold">cycle : semance</span> produit
                  tomate
                  <span className="font-bold text-blue-500">envoyer</span> avec
                  success
                </p>
              </div>
            </button>
          ...
          <button className="w-full">
            <div className="block text-center font-bold py-2">Voir plus</div>
          </button>
        </div>
      </div>
    </div>
