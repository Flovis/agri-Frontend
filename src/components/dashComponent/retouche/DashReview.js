...
import Agriculteurdash from "./Agriculteurdash";
import { useMediaQuery } from "react-responsive";

export default function DashReview() {
  const isMedium = useMediaQuery({ minWidth: 800 });
  return (
    <div className=" flex flex-col gap-6">
      ...
      <div>
        ...
        <div className="flex flex-wrap md:gap-4 gap-x-12 md:px-8 lg:flex-nowrap">
