...
export default function CardMeteo({ classname, classn }) {
    ...
    <div className="flex justify-between items-center bg-custom-white p-4 rounded-md">
      <div className={`flex items-center gap-2`}>
        ...
        <div className="flex flex-col">
          <p className={`${classname} text-deep-green font-bold`}>
            Aujourd'hui
          </p>
          <p className={`${classn} -my-1 font-extrabold`}>
      ...
      <div>
        <div className="flex gap-2">
          ...
          <p className={`${classname} text-borde-gray font-bold`}>
            (7:19 / 18:30)
          </p>
        </div>
