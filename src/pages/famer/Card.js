        ...
        <div className="h-auto border-b border-borde-gray hover:bg-[#F8F8F8]">
            <div className="p-4">
                <div className="titre mb-1">
                    ...
                    <div className="text-sm text-text-gray">Publié il y a {publish}</div>
                </div>
                <div className="body px-5 mb-4">
                    <div className="image">
                        <div className="content mb-2">{content}</div>
                        <div className="h-[300px] border border-borde-gray rounded-lg">
                ...
                <Button
                        ...
                        typ="button"
                        icon={<FaRegComment className="text-md text-text-gray hover:text-[#06B581]" />}
                    />
                </div>
            </div>
        </div>
